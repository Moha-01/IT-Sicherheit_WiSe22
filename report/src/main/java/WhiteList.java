...
public class WhiteList {
    ...
    public static void resetList() {
        ...
        en.add("flughafen_muenchen_01.jpg");
        en.add("flughafen_muenchen_02.jpg");
        en.add("flughafen_muenchen_03.jpg");
        en.add("flughafen_muenchen_04.jpg");
        en.add("flughafen_muenchen_05.jpg");
        en.add("flughafen_muenchen_06.jpg");
        en.add("flughafen_muenchen_07.jpg");
        en.add("flughafen_muenchen_08.jpg");
        en.add("flughafen_muenchen_josie_pepper.jpg");
